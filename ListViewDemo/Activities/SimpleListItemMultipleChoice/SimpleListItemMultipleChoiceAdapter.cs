...
namespace ListViewDemo
{
	...
	public class SimpleListItemMultipleChoiceAdapter: BaseAdapter<Speaker>
	{
		private readonly List<Speaker> _speakers;
		private readonly Activity _activity;

		public SimpleListItemMultipleChoiceAdapter(Activity activity, IEnumerable<Speaker> speakers)
		{

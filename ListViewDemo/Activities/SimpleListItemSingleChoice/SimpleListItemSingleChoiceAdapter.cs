...
{
	public class SimpleListItemSingleChoiceAdapter: BaseAdapter<Kitten>
	{
		private readonly List<Kitten> _kittens;
		private readonly Activity _activity;

		public SimpleListItemSingleChoiceAdapter (Activity activity, IEnumerable<Kitten> kittens)
		{

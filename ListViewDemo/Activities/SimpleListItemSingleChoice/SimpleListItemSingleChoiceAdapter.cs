...
namespace ListViewDemo
{
	...
	public class SimpleListItemSingleChoiceAdapter: BaseAdapter<Speaker>
	{
		private readonly List<Speaker> _speakers;
		private readonly Activity _activity;

		public SimpleListItemSingleChoiceAdapter(Activity activity, IEnumerable<Speaker> speakers)
		{
